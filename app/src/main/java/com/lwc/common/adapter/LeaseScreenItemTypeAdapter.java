 ...
 */
public class LeaseScreenItemTypeAdapter extends BaseAdapter{

    private Context context;
    List<MyScreenItemBean> screenItemBeans;
    public LeaseScreenItemTypeAdapter(Context context, List<MyScreenItemBean> screenItemBeans){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(myScreenItemBean.isSelect()){
            holder.tv_content.setBackgroundResource(R.drawable.button_red_round_shape_30);
            holder.tv_content.setTextColor(Color.parseColor("#FE5778"));
        }else{
            holder.tv_content.setTextColor(Color.parseColor("#333333"));
            holder.tv_content.setBackgroundResource(R.drawable.button_gray_round_shape_f0_30);
        }
