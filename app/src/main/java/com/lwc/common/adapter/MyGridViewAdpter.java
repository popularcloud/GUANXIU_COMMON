...
public class MyGridViewAdpter extends BaseAdapter{
    ...
    private List<Repairs> lists;//数据源
    private int mIndex; // 页数下标，标示第几页，从0开始
    private int mPargerSize=8;// 每页显示的最大的数量
    
    
    
    public MyGridViewAdpter(Context context, List<Repairs> lists,
    ...
    @Override
    public Repairs getItem(int arg0) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.index_home_grid_item, null);
        ...
        holder.tv_name.setText(lists.get(pos).getDeviceTypeName() + "");
//        holder.iv_nul.setImageResource();
        ImageLoaderUtil.getInstance().displayFromNet(context, lists.get(pos).getDeviceTypeIcon(), holder.iv_nul);
        //添加item监听
