...
public class OrderInvoiceFragment extends BaseFragment {
    ...
    public void clickView(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_next:
                ...
                bundle.putString("invoiceOperationType","order");
    ...
    private void getOrderList() {
        ...
        HttpRequestUtils.httpRequest(getActivity(), "InvoiceOrderList", RequestValue.GET_INVOICE_ORDER_LIST, params, "GET", new HttpRequestUtils.ResponseListener() {
            @Override
...
//		recyclerView.setLayoutManager(new VegaLayoutManager(this));
        adapter = new InvoiceOrderListAdapter(getContext(), myOrders, R.layout.item_invoice_order);
