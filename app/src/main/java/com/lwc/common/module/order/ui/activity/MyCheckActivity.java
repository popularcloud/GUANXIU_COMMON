 ...
 * @date 2017年12月01日
 */
public class MyCheckActivity extends com.lwc.common.module.BaseFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txtActionbarTitle.setText("我的优惠券");
	...
	private void addFragmenInList() {
		...
		expiresFragment = new ExpiresFragment();
		fragmentHashMap.put(0, unusedFragment);
		fragmentHashMap.put(1, uSEDFragment);
	...
	private void addRadioButtonIdInList() {
		...
		rButtonHashMap.put(2, rBtnExpires);
	}
