...
public class OrderDetailBean implements Serializable {
     ...
     * statusId : 1
     * createTime : 2020-04-29 10:14:36
     * goodsPrice : 14300
     * isShare : 0
    ...
    private String payLeaseTime; //支付时间
    private String toLeaseTime; //发货时间
    private String leaseInTime; //收货时间
    private String userMessage; //留言
    private String sendMethod; //配送方式==（0.平台 1顺丰）
    private String courierNumber; //快递单号
    private String discountAmount; //快递单号
    private String leaseMonTime; //租赁时间
    private String payType; //支付方式
    private int tuikuanNum; //退款数量
    private int tuizuNum; //退租数量
    private String sendName; //发送方式
    ...
    public String getToLeaseTime() {
        return toLeaseTime;
    }

    public void setToLeaseTime(String toLeaseTime) {
        this.toLeaseTime = toLeaseTime;
    }
    ...
    public int getTuizuNum() {
        return tuizuNum;
    }

    public void setTuizuNum(int tuizuNum) {
        this.tuizuNum = tuizuNum;
    }
