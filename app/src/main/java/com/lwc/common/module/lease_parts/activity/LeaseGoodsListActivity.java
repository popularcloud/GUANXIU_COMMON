...
import com.lwc.common.module.partsLib.ui.activity.PartsDetailActivity;
 ...
 */
public class LeaseGoodsListActivity extends BaseActivity implements PartsListView{
...
/*    @BindView(R.id.tctTip)
    ...
    protected void findViews() {
        ...
        partsBeenList.add(new PartsBean());
        partsBeenList.add(new PartsBean());
        partsBeenList.add(new PartsBean());
        partsBeenList.add(new PartsBean());
        partsBeenList.add(new PartsBean());
        leaseGoodListAdapter = new LeaseGoodListAdapter(this,partsBeenList,R.layout.item_lease_good_list);
        ...
        leaseGoodListAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int viewType, int position) {
                IntentUtil.gotoActivity(LeaseGoodsListActivity.this,LeaseGoodsDetailActivity.class);
            }
        });
    ...
    private void searchData(boolean isClickSearch){
        if(isClickSearch){
            if(TextUtils.isEmpty(searchText)){
                ToastUtil.showToast(LeaseGoodsListActivity.this,"请输入要搜索的内容");
                return;
            }
        }
        //获取列表数据
    ...
    public void onLoadDataList(List<PartsBean> returnPartsBeenList) {
        ...
        leaseGoodListAdapter.notifyDataSetChanged();
