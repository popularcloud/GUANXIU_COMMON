 ...
 * 我的订单  发票
 */
public class InvoicePackageListAdapter extends SuperAdapter<InvoicePackageOrder> {

    public InvoicePackageListAdapter(Context context, List<InvoicePackageOrder> items, int layoutResId) {
        super(context, items, layoutResId);
    }

    @Override
    public void onBind(SuperViewHolder holder, int viewType, int layoutPosition, InvoicePackageOrder item) {
      ...
      /*  String type = item.getDeviceTypeName();
        ...
        holder.setText(R.id.tv_type, item.getPackageName()); //设备类型
