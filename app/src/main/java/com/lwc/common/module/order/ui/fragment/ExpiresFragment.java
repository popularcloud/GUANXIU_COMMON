...
import com.lwc.common.module.common_adapter.ExpiresListAdapter;
 ...
 * 已过期的优惠券
 */
public class ExpiresFragment extends BaseFragment {
    ...
    private void bindRecycleView() {
        ...
        adapter = new ExpiresListAdapter(getContext(), myCoupon, R.layout.item_coupon_expire, 2);
