 ...
 * 
 */
public class ImageRollAutoOrManualView extends LinearLayout {
	 ...
	 * @param context
	 */
	public ImageRollAutoOrManualView(Context context) {
		super(context);
	}
	 ...
	 * @param attrs
	 */
	public ImageRollAutoOrManualView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
