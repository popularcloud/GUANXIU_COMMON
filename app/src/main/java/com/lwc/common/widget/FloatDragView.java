...
public class FloatDragView {
     ...
     */
    public static ImageView addFloatDragView(Activity context , ViewGroup mViewContainer,
        ...
        mViewContainer.addView(imageView,mViewContainer.getChildCount());
        return imageView;
    }
    ...
    private ImageView getFloatDragView(View.OnClickListener clickListener) {
        if (mImageView != null) {
            ...
            mImageView.setImageResource(R.drawable.ic_sign_main);
    ...
    private void setScreenHW(Activity context) {
        if (mScreenHeight < 0) {
            ...
            mScreenHeight = screen.y - Utils.getStatusBarHeightSign(context);
        }
    }
}
