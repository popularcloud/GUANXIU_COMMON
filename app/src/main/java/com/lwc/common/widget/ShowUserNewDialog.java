...
import com.lwc.common.view.BaseEffects;
...
public class ShowUserNewDialog extends Dialog {
	...
	public ShowUserNewDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
	 ...
	 * @param theme
     */
	public ShowUserNewDialog(Context context, int theme) {
		super(context, theme);
		init(context);
	}
	...
	public void setEnterBtn(final OnClickListener listener) {
		...
		btn_Button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				listener.onClick(ShowUserNewDialog.this, ID_BUTTON_1, null);
			}
		});
	}
	...
	public void setCancelBtn(final OnClickListener listener) {
		...
		btn_Button2.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				listener.onClick(ShowUserNewDialog.this, ID_BUTTON_2, null);
			}
		});
	}
	...
	public interface OnClickListener {
		 ...
		 *        附带信息
		 */
		public void onClick(ShowUserNewDialog dialog, int id, Object object);
