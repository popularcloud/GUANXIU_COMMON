package com.lwc.common.widget.CustomerDateView;
...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mCurMonthTextPaint.setTextSize(dipToPx(context,13));
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_signed_bg);
        canvas.drawBitmap(bitmap,x + mItemWidth / 3,y + mItemHeight / 4,new Paint());
    }
